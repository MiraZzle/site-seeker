...
<div class="hero">
  <div class="hero-content">
    <Header type={1}>Crawl the <span class="highlight--blue">Web</span> Today</Header>
    <Paragraph>
      Effortlessly Manage, Execute, <br />
      and Visualize Web Data
    </Paragraph>
  </div>
...
<div class="features">
  <div class="features-description">
    <Header type={2} textAlign="center">Features</Header>
    <Paragraph textAlign="center" type={2}>Unlock the Full Potential of Web Crawling</Paragraph>
  </div>
  <div class="features-cards">
    <FeatureCard>
      <svelte:fragment slot="header">Site Management</svelte:fragment>
      <svelte:fragment slot="description">
        Easily manage your website records with full CRUD operations, keeping your web crawling
        tasks organized.
      </svelte:fragment>
    </FeatureCard>
    <FeatureCard>
      ...
      <svelte:fragment slot="description">
        Set crawling boundaries with RegExp and define crawl frequency to capture relevant data
    ...
    <FeatureCard>
      ...
      <svelte:fragment slot="description">
        Monitor and manage all crawling executions with detailed logs and statuses to ensure smooth
        data collection.
      </svelte:fragment>
    </FeatureCard>
    <FeatureCard>
      ...
      <svelte:fragment slot="description">
        Visualize crawled data with interactive graphs. Switch between website and domain views for
        better insights.
      </svelte:fragment>
    </FeatureCard>
    <FeatureCard>
      ...
      <svelte:fragment slot="description">
        Access your crawled data seamlessly through a powerful GraphQL API for custom integrations
        and solutions.
      </svelte:fragment>
    </FeatureCard>
    <FeatureCard>
      ...
      <svelte:fragment slot="description">
        Start crawls manually with one click, ensuring timely data updates whenever needed.
      </svelte:fragment>
    </FeatureCard>
  </div>
</div>
